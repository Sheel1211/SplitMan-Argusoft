<template>
<section class="gradient-custom" v-if="selectedChat" style="border-radius: 15px; box-shadow: 0 5px 10px rgba(0, 191, 235, 0.5)">
    <div class="contactDetails">
        <div class="WalletParent">
            <img style="margin: 10px 10px 0px 10px" class="NeedAWallet" loading="lazy" alt="" :src="selectedChat.friend_photo" />
    ...
    <div class="container py-5">
        <div class="row">
            <div class="col-md-12 col-lg-12 col-xl-12">
                <ul class="list-unstyled text-white" ref="messagesContainer" style="height: 49vh; overflow-y: auto; padding: 10px">
                    <div v-for="message in messages" :key="message.m_id">
                        <li class="d-flex justify-content-start mb-4 " v-if="message.s_id != user_id">
                            <img :src="selectedChat.friend_photo" alt="avatar" class="rounded-circle d-inline-flex align-self-end me-3 shadow-1-strong" width="60" />
                ...
                ">
                                <div class="card-header d-flex justify-content-start p-3" style="
                  ...
                  box-shadow: 10px 10px 10px rgba(46, 54, 68, 0.03);
                ">
                                <div class="card-header d-inline-flex justify-content-end p-3" style="
                    border-bottom: 1px solid rgba(255, 255, 255, 0.3);
                    background: transparent;
                  ">
                            ...
                            <img :src="user_image" alt="avatar" class="rounded-circle d-inline-flex align-self-end ms-3 shadow-1-strong" width="60" />
                        </li>
                    </div>
                ...
                <ul class="list-unstyled text-white">
                    <li class="mb-3">
                        <div data-mdb-input-init class="form-outline form-white">
                            <textarea class="form-control" id="textAreaExample3" v-model="message" placeholder="Type your message here..." rows="4" style="display: inline-flex; width: 90%"></textarea>
                            <button type="button" @click="sendMessage" data-mdb-button-init data-mdb-ripple-init class="btn btn-light btn-lg btn-rounded float-end" style="color: black; margin: 30px 0px">
                                Send
                            </button>
                        </div>
                    </li>
...
<section class="gradient-custom chatbox" v-else style="border-radius: 15px; box-shadow: 0 5px 10px rgba(0, 191, 235, 0.5)">
...
import ViewFriendExpense from "./ViewFriendExpense.vue"
import AddFriendsExpense from "./AddFriendsExpense.vue";
...
export default defineComponent({
    ...
    methods: {
        ...
        openAddExpense() {
            this.$refs.addExpenseDialog.open();
        },
    },
});
</script>
...
.chatList {
    ...
    /* height:auto; */
    padding: var(--padding-10xl) var(--padding-4xl) var(--padding-11xl) var(--padding-15xl);
    height: 635px;
}
